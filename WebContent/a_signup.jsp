				...
				<div class="row">
					<div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
						<div class="card card-signup">
							<form class="form"  action="<%=request.getContextPath()%>/Myy" method="post">
								<input type="hidden" value="new_admin" name="action">
								<div class="header header-primary text-center">
									<h4>Welcome Sir/Mam</h4>
									<div ><h5>
										Sign Up
									</h5></div>
								</div>
								...
								<div class="content">
									...
									<div class="input-group">
										...
										<input type="password" class="form-control" placeholder="Security Password..." name="s_pass" %>">
